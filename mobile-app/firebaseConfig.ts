...
import { getAuth, initializeAuth, getReactNativePersistence, signInWithPhoneNumber, } from "@firebase/auth";
...
export { FIREBASE_APP, FIREBASE_AUTH, signInWithPhoneNumber };